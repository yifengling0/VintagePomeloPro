...
#include "compositor/frame/compositor_utils.h"         // CompensateMinimizedSubsurfaceOffset
#include "compositor/toplevel/desktop_compositor.h"       // DesktopCompositor (friend), SubsurfaceLayer
#include "compositor/frame/geometry.h"                 // DisplaySizeAfterViewport
